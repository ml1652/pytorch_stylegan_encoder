...
#label = 'landmarks'
label = 'Mouth_Slightly_Open' # Eyeglasses,Smiling,Mouth_Slightly_Open, Blurry, Wearing_Hat, Wearing_Necktie
...
if label == 'landmarks':
    torch.save(celeba_regressor.state_dict(),
               f"C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Trained_model/Celeba_Regressor_" + str(landmarks_num)+ "_landmarks"+ ".pt")
else:
    torch.save(celeba_regressor.state_dict(),
               f"C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Trained_model/Celeba_Regressor_" +label +".pt")