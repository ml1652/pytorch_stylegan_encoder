...
image_directory ="/scratch/staff/ml1652/StyleGAN_Reconstuction_server/align_size(224,224)_move(0.250,0.000)_face_factor(0.800)_jpg/data"
image_size = 64
...
data = pd.read_csv(
            "/scratch/staff/ml1652/StyleGAN_Reconstuction_server/align_size(224,224)_move(0.250,0.000)_face_factor(0.800)_jpg/tformed_landmark_68point.txt",
            sep=' ',
            header=None,
        )
data = data.to_numpy()
...
#optimizer = torch.optim.SGD(image_to_latent.parameters(), lr= 3e-6, weight_decay = 5e-4,momentum=0.9) # L2: lr=3e-6 otherloss: lr=3e-5
optimizer = torch.optim.SGD(image_to_latent.parameters(), lr= 0.001) # L2: lr=3e-6 otherloss: lr=3e-5
...
# save moodel
torch.save(image_to_latent.state_dict(), f"/scratch/staff/ml1652/StyleGAN_Reconstuction_server/Pretrained_model/Image_to_landmarks_Regressor_batchnorm.pt")
...
plt.savefig("/scratch/staff/ml1652/StyleGAN_Reconstuction_server/diagram/accuracy_loss_epoch_img_to_landmarks_model.jpg")
