...
parser.add_argument("--vggface_to_latent", default= False , help="Use vgg_to_latent model to intialise latent", type=bool)
parser.add_argument("--vgg_to_hist", default= True , help="Use vgg_to_hist model ", type=bool)
parser.add_argument("--weight_histloss", default=0.01, help="the weight of vgg_to_histogram in loss  function",type= float)
args, other = parser.parse_known_args()

IdlossAndLandmarkTraingSteps = args.iterations - 1500
...
def draw_SoftHistTest(hist_target, hist_pred):
    ...
    plt.plot(hist_target[0], color="green", linestyle='-', label='target')
    ...
    if args.Inserver == False:
        str1 = 'C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Non_ID_result/SoftHistTest__lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss) + '_iter=' + str(args.iterations) + '_'
        str2 = (args.image_path).split('\\')[-1]
    else:
        str1 = '/scratch/staff/ml1652/StyleGAN_Reconstuction_server/learningrate_Test/SoftHistTest__lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss) + '_iter=' + str(args.iterations) + '_'
        str2 = (args.image_path).split('/')[-1]
...
def draw_histogram_target_generateImg(reference_img, generated_img):
    ...
    plt.plot(hist_pred[2], color="red", linestyle='-')
    if args.Inserver == False:
        str1 = 'C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Non_ID_result/Histogram_histc_TargetAndGeneratedImgCompare__lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss) + '_iter=' + str(args.iterations) + '_'
        str2 = (args.image_path).split('\\')[-1]
    else:
        str1 = '/scratch/staff/ml1652/StyleGAN_Reconstuction_server/learningrate_Test/Histogram_histc_TargetAndGeneratedImgCompare__lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss) + '_iter=' + str(args.iterations) + '_'
        str2 = (args.image_path).split('/')[-1]
...
def feed_vggFeatures_into_histogramRegressor(X_target,bins_num):
    ...
    features_to_hist = VGGToHist(bins_num).cuda().eval()
    ...
    if args.Inserver == False:
        ...
        features_to_hist.load_state_dict(torch.load(
            '/scratch/staff/ml1652/StyleGAN_Reconstuction_server/Pretrained_model/'+ hist_file_name))
...
for step in progress_bar:
    ...
    if lagrangianloss == True:
        ...
        #lagrangian = Id_l - lambdA * (epsilon - Landmark_l)

    if count == 1:
        #str1 = "/scratch/staff/ml1652/StyleGAN_Reconstuction_server/croped_img/"

        if args.Inserver == False:
            str1 = 'C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Non_ID_result/frist_image_Non_ID_reconstructor_lr='+str(args.learning_rate)+'_b='+str(args.weight_landmarkloss)+'_iter='+str(args.iterations)+'_'
            str2 = (args.image_path).split('\\')[-1]
        else:
            str1 = '/scratch/staff/ml1652/StyleGAN_Reconstuction_server/learningrate_Test/frist_image_Non_ID_reconstructor_lr='+str(args.learning_rate)+'_b='+str(args.weight_landmarkloss)+'_iter='+str(args.iterations)+'_'
            str2 = (args.image_path).split('/')[-1]
...
if args.Inserver == False:
    if args.Inserver == False:
        str1 = 'C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Non_ID_result/loss_trajectories_lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss) + '_iter=' + str(args.iterations) + '_'
...
if  args.vgg_to_hist == True:
    if args.Inserver == False:
        str1 = 'C:/Users/Mingrui/Desktop/Github/pytorch_stylegan_encoder/Non_ID_result/histogramloss__lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss)+'_iter='+str(args.iterations)+'_'
        str2 = (args.image_path).split('\\')[-1]
    else:
        str1 = '/scratch/staff/ml1652/StyleGAN_Reconstuction_server/learningrate_Test/histogramloss__lr=' + str(
            args.learning_rate) + '_b=' + str(args.weight_landmarkloss)+'_iter='+str(args.iterations) + '_'
        str2 = (args.image_path).split('/')[-1]
    plot_path = str1+str2
    plt.figure()
